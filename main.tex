...
\todo[inline]{structured and non-structured}
...
\todo[inline]{Esempio anche, con idea di cosa sia un argomento}
...
\todo[inline]{BG problemi nuovi su cambiamento grafo}
...
\todo[inline]{Fare rissunto di quello che abbiamo fatto ed  encoding nuovo}
